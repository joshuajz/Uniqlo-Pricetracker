...
function DashRow({ product: p }: { product: Product }) {
  ...
  return (
    <div className="border-b border-gray-100 group">
      ...
      <div className="sm:hidden flex items-center gap-3 px-1 py-3">
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1.5 mt-1 flex-wrap">
            ...
            {p.gender && <span className="text-[11px] text-gray-300">{genderLabel(p.gender)}</span>}
      ...
      {/* ── Desktop layout ── */}
      <div className="hidden sm:grid grid-cols-[1fr_120px_100px_88px_80px] items-center gap-3 px-2 py-3 -mx-2 group-hover:bg-stone-100">
        {/* Name + category */}
        <div>
        ...
        {/* ATL price */}
        <div className="text-right">
          <div className="text-[13px] font-semibold text-gray-900">${p.lowest_price.toFixed(2)}</div>
          <div className="text-[11px] text-gray-300">all-time low</div>
        </div>
...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-[1100px] mx-auto px-4 sm:px-6 pt-10 pb-[60px]">
      ...
      <div className="hidden sm:grid grid-cols-[1fr_120px_100px_88px_80px] gap-3 px-2 py-2 border-b border-gray-200">
