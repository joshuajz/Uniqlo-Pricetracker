...
const FAQS = [
  { id: 'about', q: 'What is Uniqlo Price Tracker?', a: 'A free tool for comparing Uniqlo prices in Canada, the United States, the United Kingdom, and Japan with their recorded history. Browse deals, check past prices, and find items at their lowest recorded price.' },
  ...
  { id: 'region', q: 'Which region and currency does it cover?', a: 'Choose Canada (CAD), the United States (USD), the United Kingdom (GBP), or Japan (JPY) in the country selector. Each has its own catalogue and price history; prices are not converted between currencies. We remember your country in this browser. New visitors start with Canada, and country-specific links always open the country in the URL.' },
  { id: 'price-comparisons', q: 'How are deals and typical tracked prices calculated?', a: 'The typical tracked price is the most frequently recorded price for a product across its history. When two prices occur equally often, we use the higher one. Deals are below that price, and discount percentages compare the current recorded price with it. Newer countries may have only a few days of history and fewer deals. This baseline can change as more prices are recorded; it may differ from Uniqlo’s list price or advertised promotions.' },
