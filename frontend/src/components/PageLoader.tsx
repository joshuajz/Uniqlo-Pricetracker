  ...
  return (
    <div className="max-w-[1100px] mx-auto px-4 sm:px-6 pt-10 pb-[60px] animate-pulse">
      ...
      <div className="mb-8">
        ...
        <div className="h-3 w-48 bg-stone-200 rounded mt-3" />
      </div>

      {/* Stat cards */}
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 mb-9">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="border-t-[3px] border-stone-200 pt-3">
      ...
      {/* Rows */}
      <div className="border-t-2 border-stone-200 pt-1">
        {Array.from({ length: 8 }).map((_, i) => (
          ...
          >
            <div className="w-12 h-12 bg-stone-200 rounded shrink-0" />
            ...
            <div className="text-right space-y-2 shrink-0">
              ...
              <div className="h-2.5 w-10 bg-stone-100 rounded ml-auto" />
            </div>
          </div>
        ))}
      </div>
